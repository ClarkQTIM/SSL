...
'''
This script is used to fine-tune a from_pretrained ViTMAE.

The original can be found here: https://github.com/huggingface/transformers/blob/main/examples/pytorch/image-pretraining/run_mae.py

The script to run this can be found here: https://github.com/huggingface/transformers/blob/main/examples/pytorch/image-pretraining/README.md

A sample is:

python /projects/Cervical_Cancer_Projects/SSL/custom_mae/src/vitmae_finetune_from_pretrained_hf.py \
    ...
    --output_dir /projects/Cervical_Cancer_Projects/SSL/custom_mae/Reconstruction_Finetune_Best_Models/Facebook_Base_Cervix \
